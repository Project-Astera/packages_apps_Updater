...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "org.astera.version";
    public static final String PROP_DEVICE = "ro.astera.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "astera.updater.allow_downgrading";
